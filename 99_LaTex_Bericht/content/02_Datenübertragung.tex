...
\end{lstlisting}
Anschließend kann auf dem Laptop (Windows 11, 64-Bit-System) das folgende Testprogramm ausgeführt werden. In der Konsolen-Ausgabe werden die empfangenen Datenpakete angezeigt.
\begin{lstlisting}
import paho.mqtt.client as mqtt
...
Zunächst muss der Mosquitto MQTT Broker auf dem Raspberry Pi installiert werden:
\begin{lstlisting}
