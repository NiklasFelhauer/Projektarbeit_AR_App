...
\newline
Bei der Bereitstellung eines drahtlosen Netzwerks erstellt der Access Point lokales WLAN, zu dem sich Geräte verbinden können. Das Netzwerk wird durch die SSID (Service Set Identifier, der WLAN-Name) und eine Verschlüsselung gekennzeichnet.
\newline
Bei der erbindung mit kabelgebundenen Netzwerken ist der Acces Point normalerweise mit einem Router, Switch oder Server über ein über ein Ethernet-Kabel verbunden. So verbindet er die drahtlosen Geräte mit dem bestehenden Netzwerk.
\newline 
Außerdem bietet der Acces Point Sicherheitsprotokolle zur Verschlüsselung der Daten.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newline 
Es gibt verschiedene Anwendungsbereiche des Acces Points. Dazu gehören das Erweitern von Netzwerken, die Erstellung lokaler Netwerke und die Mobile Anwendung eines Acces Points. 
\newline 
...
\newline 
Zur Verbindung mit dem Hauptnetzwerk verwendet der Acces Point Ethernet. Geräte die sich im WLAN befinden erhalten durch den Access Point Zugriff aufs Internet oder loklae Daten. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newline 
